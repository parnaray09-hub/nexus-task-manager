      ...
      <div className="w-full max-w-[400px] space-y-8">
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-400">Initialize your team workspace.</p>
          </div>
        </div>
        ...
        <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-8 shadow-2xl shadow-black/50">
          <form action={formAction} className="space-y-6">
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-xs text-zinc-400 font-medium ml-1">Password</Label>
                <Input
                  id="password" name="password" type="password" required placeholder="Minimum 6 characters"
                  className="bg-white/[0.02] border-white/5 text-white placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-white/20 focus-visible:border-white/10 h-11 rounded-lg transition-all"
                />
              </div>
            </div>
        ...
        <p className="text-center text-[13px] text-zinc-500">
          ...
          <Link href="/login" className="text-white hover:text-zinc-300 font-medium underline underline-offset-4 decoration-white/20 hover:decoration-white/50 transition-all">Sign in</Link>
        </p>
      </div>
    </div>
  )
